...
public static class DomainErrors
{
    ...
    {
        public static readonly Error UserDoesNotExist = new("GetUser.UserDoesNotExist", "User with the provided Id does not exist.");
    }
    ...
    public static class InternalRequest
    {
        ...
        public static readonly Error SecretHeaderMissing = new("InternalRequest.SecretHeaderMissing", "Secret header was not provided.");
    }
}